...
const FEATURES = [
  ...
  { href: "/portal/requests", icon: Ticket, title: "My Requests", body: "Track the status of everything you’ve raised." },
  { href: "/portal/approvals", icon: CheckSquare, title: "Approvals", body: "Review and approve requests awaiting your sign-off." },
];
